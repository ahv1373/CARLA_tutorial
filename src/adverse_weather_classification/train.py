...
for root_dir, cur_dir, files in os.walk('/home/mahdi/PycharmProjects/test'):
...
class TrainCustomCNN(TrainHyperParameters):
    ...
    def plot_history(self, history):
        ...
        plt.title('Accuracy')
        plt.legend()
        plt.savefig(os.path.join(self.checkpoint_dir, 'loss.png'), dpi=300)
...
if __name__ == '__main__':
    data_dir_ = '/home/mahdi/PycharmProjects/output'
