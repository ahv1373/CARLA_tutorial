...
if __name__ == "__main__":
    ...
    # potential weather we have :[ClearNoon, ClearSunset, CloudyNoon, CloudySunset,
    #The weathers WetNoon, WetSunset, MidRainyNoon, MidRainSunset, HardRainNoon, HardRainSunset,
    # SoftRainNoon, SoftRainSunset]

    #  sensors we are adding to the problem
    ...
    #  sensor data that we have coolected
